...
public class NetWorkUtils {
  ...
  public static void openWirelessSettings() {
    BaseApplication.getContext().startActivity(
  ...
  public static boolean getWifiEnabled() {
    ...
    WifiManager manager = (WifiManager) BaseApplication.getContext().getSystemService(WIFI_SERVICE);
  ...
  public static String getNetworkOperatorName() {
    TelephonyManager tm =
      (TelephonyManager) BaseApplication.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    //noinspection ConstantConditions
